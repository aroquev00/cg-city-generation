...
export class Bone {
  ...
  public length: number; // Length of the bone.
  ...
  constructor(bone: BoneLoader) {
    ...
    let boneLengthVector = new Vec3;
    this.endpoint.subtract(this.position, boneLengthVector);
    this.length = boneLengthVector.length();
  }
}
